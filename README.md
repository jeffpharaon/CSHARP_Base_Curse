...
В котором у нас определено пространство имен, в котором будет выполняться наш код, класс, входная точка для выполненяи кода и вывод в консоль. Обо всем подробнее мы поговорим чуть позже. Все по порядку.
