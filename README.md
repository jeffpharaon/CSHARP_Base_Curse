...
В котором у нас определено пространство имен, в котором будет выполняться наш код, класс, входная точка для выполнения кода и вывод в консоль. Обо всем подробнее мы поговорим чуть позже. Все по порядку.  
...
Так же можно выводить в консоль данные из переменных, так же достаточно без ковычек внутри скобки просто вписать название переменной, но о них чуть позже.  
Еще можно комбинировать типы данных при помощи символа `+`.  
А еще можно вставлять данные из переменных например прямо посреди текста без использования `+`. Для этого в скобках перед ковычками необходимо поставить знак `$` в ковычках в необходимом месте в тексте указать название переменной в фигиурных скобках `{}`.
