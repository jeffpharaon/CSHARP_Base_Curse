...
Далее в терминале (его можно вызвать сочетанием клавиш `Ctrl + ё` или в верхней панеле задач нажать на Terminal) можно прописать следующую команду `dotnet new` чтобы увидеть все возможные проекты которые вы можете создать:
